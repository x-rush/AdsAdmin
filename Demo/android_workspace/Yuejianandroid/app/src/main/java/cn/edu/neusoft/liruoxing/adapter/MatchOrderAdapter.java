...
public class MatchOrderAdapter extends RecyclerView.Adapter<MatchOrderAdapter.ViewHolder> {

    private MatchOrderBean mData;

    public MatchOrderAdapter(MatchOrderBean data) {
        this.mData = data;
    }
