<?php /* Smarty version Smarty-3.1.6, created on 2019-05-13 13:16:34
         compiled from "./Home/Tpl\Message\mine.html" */ ?>
<?php /*%%SmartyHeaderCode:9867973465cd8fdb2b36128-85262251%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5788e94261226d2707c9eed7ccaa3f26a76489c2' => 
    array (
      0 => './Home/Tpl\\Message\\mine.html',
      1 => 1393463458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9867973465cd8fdb2b36128-85262251',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cd8fdb2bedac',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cd8fdb2bedac')) {function content_5cd8fdb2bedac($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'E:\\PHP\\wamp64\\www\\edu1\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
<?php }?>
                        ...
                        <div style='margin:0px 0px 0px 50px;width:74%;float:left;height:17px;font:normal 12px "宋体";'>
...
'>他的关注</a>
                    ...
                    <br>
                    <div class="tt">
                        <h3><?php if ($_smarty_tpl->tpl_vars['user']->value['id']==$_SESSION['user']['id']){?>我的帖子<?php }else{ ?>他的帖子<?php }?></h3>
                    </div>
...
、<?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['vo']->value['title'],13,'...',true);?>
                            ...
                            <span style='margin:5px 0px 0px 0px;float:left;width:180px;font:normal 14px "宋体"'>
                            ...
                            <span style='float:left;width:10px;text-align:center'>
                                <?php if ($_smarty_tpl->tpl_vars['user']->value['id']==$_SESSION['user']['id']){?>
                                    <a href='__APP__/Message/delete/id/<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
'><img alt='删除'style='margin-top:-4px;' class="img" src="__PUBLIC__/images/del.png"></a>
                                <?php }?>
                            </span>
                        </li>
                        <?php } ?>
                    ...
                    <div class="tt">
                        <h3><?php if ($_smarty_tpl->tpl_vars['user']->value['id']==$_SESSION['user']['id']){?>我的问题<?php }else{ ?>他的问题<?php }?></h3>
                    </div>
                    <div class="m_n_item_info f12 c999" style='background:url("__PUBLIC__/images/m_bt.jpg") repeat-x'>
                        <span class="g_topic_t ml10">　　　问题简介　　　</span>
                        <span class="g_topic_t ml10">被提问教师</span>
...
?>
                        <li class='m_newlist'> 
                            <div class="t_ml_120" style='margin-left:0px;float:left;width:44%'>
                                <a href="__APP__/Question/show/id/<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['vo']->iteration;?>
、<?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['vo']->value['content']),13,'...',true);?>
</a>
                                <?php if ($_smarty_tpl->tpl_vars['vo']->value['isbest']=='1'){?><img style='margin-top:-2px' src='__PUBLIC__/images/best.png'><?php }?>
                            </div>
                            <span style='margin:5px 0px 0px 0px;float:left;width:90px;font:normal 14px "宋体";'>
                                <?php echo $_smarty_tpl->tpl_vars['vo']->value['tname'];?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['vo']->value['replay']==''){?>
                                <span style='border:1px solid #ddd;background:red;color:#fff;margin:5px 0px 0px 10px;text-align:center;float:left;width:60px;font:bold 14px "楷体"'>未回复</span>
                            <?php }else{ ?>
                                <span style='border:1px solid #ddd;background:blue;color:#fff;margin:5px 0px 0px 10px;text-align:center;float:left;width:60px;font:bold 14px "楷体"'>已回复</span>
                            <?php }?>

                            <span style='float:left;width:33px;text-align:center'>
                                <?php if ($_smarty_tpl->tpl_vars['user']->value['id']==$_SESSION['user']['id']){?>
                                    <a href='__APP__/Question/delete/id/<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
'><img alt='删除'style='margin-top:-4px;' class="img" src="__PUBLIC__/images/del.png"></a>
                                <?php }?>
                            </span>
                        </li>
