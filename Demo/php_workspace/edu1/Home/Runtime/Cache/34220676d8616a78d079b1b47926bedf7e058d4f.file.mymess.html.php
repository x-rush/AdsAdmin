<?php /* Smarty version Smarty-3.1.6, created on 2019-05-13 13:16:37
         compiled from "./Home/Tpl\Message\mymess.html" */ ?>
<?php /*%%SmartyHeaderCode:21465624335cd8fdb5cd8bc9-03499674%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '34220676d8616a78d079b1b47926bedf7e058d4f' => 
    array (
      0 => './Home/Tpl\\Message\\mymess.html',
      1 => 1393463458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21465624335cd8fdb5cd8bc9-03499674',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cd8fdb60421e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cd8fdb60421e')) {function content_5cd8fdb60421e($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'E:\\PHP\\wamp64\\www\\edu1\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
<?php }?>
                        ...
                        <button class='like' vv='n' style='display:<?php if ($_smarty_tpl->tpl_vars['user']->value['like']!="y"){?>block<?php }else{ ?>none<?php }?>;margin:15px 0px 0px 150px;float:left;width:55px;color:#f00;background:#83ADCE;height:25px;font:bold 12px "宋体";'><b>+</b> 关注</button>
                        <?php }?>
...
　提问：<?php echo $_smarty_tpl->tpl_vars['mnum2']->value;?>
                        ...
                        <div class='menu' style='background:#A76CAF'>
                            <a style='color:#fff' href='__APP__/Message/mymess'>我的帖子</a>
                        </div>
                        <div class='menu'>
                        ...
                        <?php }else{ ?>
                        <div class='menu' style='background:#A76CAF'>
                            <a style='color:#fff' href='__APP__/Message/mymess/uid/<?php echo $_GET['uid'];?>
'>他的帖子</a>
                        </div>
                        <div class='menu'>
...
、<?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['vo']->value['title'],13,'...',true);?>
                            ...
                            <span style='margin:5px 0px 0px 0px;float:left;width:170px;font:normal 14px "宋体"'>
                            ...
                            <span style='margin:0px;float:left;width:20px;text-align:center'>
                                <?php if ($_smarty_tpl->tpl_vars['user']->value['id']==$_SESSION['user']['id']){?>
