...
public class TrainEnrollActivity extends AppCompatActivity {
    @BindView(R.id.image)
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_enroll);
    ...
    private void initData() {
        Glide.with(MyApplication.getAppContext())
                .load(MyApplication.getImagePath() + getIntent().getStringExtra("train_pic"))
                .into(image);
    ...
    private void enroll11() {
        ...
        Call<StatusBean> call = service.enroll(getSharedPreferences("yj", MODE_PRIVATE).getString("id", "0"),
                getIntent().getStringExtra("train_id"), tv_num.getText().toString());
