<?php /* Smarty version Smarty-3.1.6, created on 2019-05-13 13:16:36
         compiled from "./Home/Tpl\Message\myques.html" */ ?>
<?php /*%%SmartyHeaderCode:16249354645cd8fdb4ba7ce0-94234887%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '432f5289e0dfec8784a5d063228069a602581bce' => 
    array (
      0 => './Home/Tpl\\Message\\myques.html',
      1 => 1393463458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16249354645cd8fdb4ba7ce0-94234887',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cd8fdb4cff93',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cd8fdb4cff93')) {function content_5cd8fdb4cff93($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'E:\\PHP\\wamp64\\www\\edu1\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
　提问：<?php echo $_smarty_tpl->tpl_vars['mnum2']->value;?>
                        ...
                        <div class='menu' style='background:#A76CAF'>
                            <a style='color:#fff' href='__APP__/Message/myques'>我的问题</a>
                        </div>
                        <div class='menu'>
...
'>他的帖子</a>
                        ...
                        <div class='menu' style='background:#A76CAF'>
                            <a style='color:#fff' href='__APP__/Message/myques/uid/<?php echo $_GET['uid'];?>
'>他的问题</a>
                        </div>
                        <div class='menu'>
...
?>
                        <li class='m_newlist'> 
                            <div class="t_ml_120" style='margin-left:0px;float:left;width:47%;'>
...
、<?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['vo']->value['content']),16,'...',true);?>
                            ...
                            <span style='margin:5px 0px 0px 0px;float:left;width:75px;font:normal 14px "宋体";'>
                                <?php echo $_smarty_tpl->tpl_vars['vo']->value['tname'];?>

                            </span>
                            <span style='margin:5px 0px 0px 10px;float:left;width:140px;font:normal 14px "宋体"'>
                            ...
                            <span style='margin:0px;float:left;width:25px;text-align:center'>
                                <?php if ($_smarty_tpl->tpl_vars['user']->value['id']==$_SESSION['user']['id']){?>
